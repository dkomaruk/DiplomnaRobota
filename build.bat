...
SET COMPILER_FLAGS=/std:c++20 -nologo -WX -W4 %WARNINGS_ON_UNIMPLEMENTED_ENUM_SWITCH_CASES% -EHsc -Zc:strictStrings-
...
SET PROJECT_INCLUDES=-I"..\code\game" -I"..\code\external" -I"..\code\engine" -I"..\code\engine\renderer" -I"..\code\engine\shapes" -I"..\code\editor" -I"..\code\tracy-0.13.1"
